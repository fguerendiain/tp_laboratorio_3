...
class AccesoDatos
{
    ...
    public function __construct()
    {
        try {
            ...
            $this->_objetoPDO = new PDO('mysql:host=localhost:8080;dbname=recuperatorio;charset=utf8', '', '', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
